  ...
  return (
    <div className="space-y-6 px-4 py-6 w-full md:max-w-xs">
      ...
      <div className="text-center">
        ...
        <span className="mt-2 inline-block rounded-full px-3 py-1 text-xs font-medium bg-accent text-foreground">
          Free Plan
        </span>
      </div>

      {/* Message Usage */}
      <div className="space-y-4 rounded-lg bg-card dark:bg-card p-4 shadow-sm">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="text-sm text-primary">0/20</span>
          </div>
          <div className="h-2 w-full overflow-hidden rounded-full bg-accent dark:bg-accent ">
            <div
            ...
            <div key={label} className="flex items-center justify-between">
              ...
              <div className="flex gap-1">
                {keys.map((key) => (
                  <kbd
                    key={key}
                    className="rounded bg-accent dark:bg-accent dark:text-foreground px-2 py-1 text-sm text-foreground"
                  >
                    {key}
                  </kbd>
                ))}
